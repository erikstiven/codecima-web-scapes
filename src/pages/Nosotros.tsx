        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="relative">
              ...
              <img
                ...
                className="relative rounded-lg w-full h-auto object-cover border-2 border-codecima-blue/50"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
            {stats.map((stat, index) => (
              <div key={index} className="bg-codecima-darkblue rounded-lg p-6 text-center border-2 border-codecima-blue/50 hover:border-codecima-blue transition-all">
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {values.map((value, index) => (
                <div key={index} className="bg-codecima-darkblue rounded-lg p-6 border-2 border-codecima-blue/50 hover:border-codecima-blue transition-all group">
